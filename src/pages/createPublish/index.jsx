...
const CreatePublish = () => {
  ...
  const Title = ({text, subTitle}) => {
    return <Text className="createPublish-section__title">{text} <Text>{ subTitle}</Text> </Text>
  }
  ...
  return (
    <View className="createPublish">
      ...
      <View className="createPublish-section">
        <Title text="发起人联系电话" />
        <View className="createPublish-section__add line flex flex-left-center flex-between-center">
          <Input type="numer" className='placeholderColor' placeholder="请输入联系电话" />
        </View>
      </View>
      ...
      <View className="createPublish-section">
        ...
        <View className="createPublish-section__add line flex flex-left-center flex-between-center">
          <Input type="text" className='placeholderColor' placeholder="请输入您的姓名" />
        </View>
      </View>
      ...
      <View className="createPublish-section">
        ...
        <View className="createPublish-section__add line flex flex-left-center flex-between-center">
          <Input type="text" className='placeholderColor' placeholder="留下微信号方便好友联系到你哦" />
        </View>
      </View>
      ...
      <View className="createPublish-section">
        ...
        <View className="createPublish-section__add line flex flex-left-center flex-between-center">
          <Input type="textarea" className='placeholderColor' placeholder="请填写备注 字数不要超过40个字符（此处40是暂时的）" />
        </View>
      </View>
